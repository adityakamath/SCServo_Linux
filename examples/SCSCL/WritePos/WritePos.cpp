...
int main(int argc, char **argv)
{
	...
	while(1){
		sc.WritePos(1, 1000, 0, 1500);//Servo (ID1) moves to P1=1000 at max speed V=1500 steps/sec
		std::cout<<"pos = "<<1000<<std::endl;
		usleep(754*1000);//[(P1-P0)/V]*1000+100

		sc.WritePos(1, 20, 0, 1500);//Servo (ID1) moves to P1=20 at max speed V=1500 steps/sec
