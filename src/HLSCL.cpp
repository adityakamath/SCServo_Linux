...
int HLSCL::ReadPos(int ID)
{
	if (ServoUtils::isCachedRead(ID)) {
		u16 encodedPos = ServoUtils::readWordFromBuffer(Mem, HLSCL_PRESENT_POSITION_L - HLSCL_PRESENT_POSITION_L,
...
{
	if (ServoUtils::isCachedRead(ID)) {
		u16 encodedSpeed = ServoUtils::readWordFromBuffer(Mem, HLSCL_PRESENT_SPEED_L - HLSCL_PRESENT_POSITION_L,
...
{
	if (ServoUtils::isCachedRead(ID)) {
		u16 encodedLoad = ServoUtils::readWordFromBuffer(Mem, HLSCL_PRESENT_LOAD_L - HLSCL_PRESENT_POSITION_L,
...
{
	if (ServoUtils::isCachedRead(ID)) {
		u16 encodedCurrent = ServoUtils::readWordFromBuffer(Mem, HLSCL_PRESENT_CURRENT_L - HLSCL_PRESENT_POSITION_L,
